                ...
                <Col xs="12" sm="12" lg="3">
                    <Col xs="12" className="product p-0">
                        <Col xs="12" className="product-logo p-0">
                            <img src="https://wikb.modeltheme.com/wp-content/uploads/2019/06/theme-block1.jpg" alt="" />
                        </Col>
                        <Col xs="12" className="product-detail">
                            <Row className="m-0">
                                <Col xs="10" className="pr-0">
                                    <h6 className="product-name">Oklahoma</h6>
                                    <h6 className="product-category">WordPress Theme</h6>
                                </Col>
